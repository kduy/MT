...
For example, window contains last 2 transactions once every 2 transaction passed. Up to 5 a.m, the stream contains 3 windows (Figure~\ref{fig:tumblingWin})
