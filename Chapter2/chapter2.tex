...
\end{verbatim}
means that window cover all transactions with $Quantity > 100.000$ over last 2 hours once 1 hour. Transaction tuples inside the window are partitioned into group specified by Exchange keyword Figure~\ref{fig:winSpec}
