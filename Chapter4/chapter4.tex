...
\begin{itemize}
	\item \textbf{Language closure}: it ensures that the output of any one query can be input to another query
	\item \textbf{Windowing} FlinkCQL should allow to define window specification and  implement related operators
